...
public class LoginStepDef extends Base {
	...
	// we cant have duplicate methods for steps in secenario steps.
	// in order to get access to POM class methods we need to create object of LoginPageObject class
	...
	// if actual dose not equals to expected value then execution wil stop
		// and test step will fail.
		Assert.assertEquals(expectedPageTitle, actualPageTitile);
		logger.info("Actural Title is matching with expected Title");
	}
	...
	public void user_enter_userName__and_password(String uName, String pass){
